...
!function() {
    ...
    a.fn.Jlazyload = function(b, c) {
        if (this.length) {
            var d, e, f = a.extend({type: null,offsetParent: null,source: "data-lazyload",placeholderImage: "../images/广告.png",placeholderClass: "loading-style2",threshold: 200}, b || {}), g = this, h = function(a) {
