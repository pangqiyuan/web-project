...
<div id="o-header-2013">
	<div class="w" id="header-2013" style="background-color: #e9f0f6;"	>
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/logo.jpg" width="140" height="60" alt="易购"></a></div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					<input type="text" class="text" accesskey="s" id="key" autocompleteyle="off" onkeydown="javascript:if(event.keyCode==13) search('key');">
		...
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<li class="fore4" id="nav-tuan" clstag="homepage|keycount|home2013|07d"><a href="http://localhost:8083/search.html?q=美妆" target="_blank">美妆</a></li>
					<li class="fore5" id="nav-auction" clstag="homepage|keycount|home2013|07e"><a href="http://localhost:8083/search.html?q=服饰">服饰</a></li>
					<li class="fore6" id="nav-shan" clstag="homepage|keycount|home2013|07f"><a href="http://localhost:8083/search.html?q=美食" target="_blank">美食</a></li>
					<li class="fore7" id="nav-jinrong" clstag="homepage|keycount|home2013|07g1"><a href="http://localhost:8083/search.html?q=家居" target="_blank">家居</a></li>
				</ul>
		</div>
	</div>
</div>
