...
<div id="o-header-2013">
	<div class="w" id="header-2013" style="background-color: #e8f0f3;">
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/logo.jpg" width="200" height="60" alt="易购"></a></div>
		<!--logo end-->
		<div id="search-2013">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><s></s><a href="http://localhost:8084/user/showLogin" clstag="homepage|keycount|home2012|04a">我的易货</a><b></b></dt>
				<dd>
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<!-- <dt class="ld"><s></s><span class="shopping"></span><a href="/cart/cart.html" id="settleup-url">去购物车结算</a> <b></b> </dt> -->
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
	...
	<div class="w">
		<div id="nav-2013">
			<div id="categorys-2013" class="categorys-2014">
				<div class="mt ld">
					<h2><a href="http://www.jd.com/allSort.aspx" clstag="homepage|keycount|home2013|06a">全部商品分类</a></h2>
				</div>
...
http							</h3>
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<li class="fore2" id="nav-fashion" clstag="homepage|keycount|home2013|07b"><a href="http://localhost:8083/search.html?q=运动">运动</a></li>
					<li class="fore3" id="nav-chaoshi" clstag="homepage|keycount|home2013|07c"><a href="http://localhost:8083/search.html?q=数码">数码</a></li>
					<li class="fore4" id="nav-tuan" clstag="homepage|keycount|home2013|07d"><a href="http://localhost:8083/search.html?q=美妆" >美妆</a></li>
					<li class="fore5" id="nav-auction" clstag="homepage|keycount|home2013|07e"><a href="http://localhost:8083/search.html?q=服饰">服饰</a></li>
					<li class="fore6" id="nav-shan" clstag="homepage|keycount|home2013|07f"><a href="http://localhost:8083/search.html?q=美食" >美食</a></li>
					<li class="fore7" id="nav-jinrong" clstag="homepage|keycount|home2013|07g1"><a href="http://localhost:8083/search.html?q=家居" >家居</a></li>
				</ul>
		</div>
	</div>
</div>
